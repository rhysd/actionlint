...
var PopularActions = map[string]*ActionMetadata{
	"8398a7/action-slack@v3": {
		...
		Inputs: ActionMetadataInputs{
			...
			"cancelled_message": {"cancelled_message", false},
			"channel":           {"channel", false},
			"custom_payload":    {"custom_payload", false},
			"failure_message":   {"failure_message", false},
			"fields":            {"fields", false},
			...
			"status":            {"status", true},
			"success_message":   {"success_message", false},
			"text":              {"text", false},
	...
	"SamKirkland/FTP-Deploy-Action@v4.3.6": {
		Name: "FTP Deploy",
		Inputs: ActionMetadataInputs{
			"dangerous-clean-slate": {"dangerous-clean-slate", false},
			"dry-run":               {"dry-run", false},
			"exclude":               {"exclude", false},
			"local-dir":             {"local-dir", false},
	...
	"actions-cool/issues-helper@v3": {
		...
		Inputs: ActionMetadataInputs{
			...
			"create-issue-if-not-exist": {"create-issue-if-not-exist", false},
	...
	"actions/ai-inference@v1": {
		Name: "AI Inference",
		Inputs: ActionMetadataInputs{
			"enable-github-mcp":  {"enable-github-mcp", false},
			"endpoint":           {"endpoint", false},
			"file_input":         {"file_input", false},
			"github-mcp-token":   {"github-mcp-token", false},
			"input":              {"input", false},
			"max-tokens":         {"max-tokens", false},
			"model":              {"model", false},
			"prompt":             {"prompt", false},
			"prompt-file":        {"prompt-file", false},
			"system-prompt":      {"system-prompt", false},
			"system-prompt-file": {"system-prompt-file", false},
			"token":              {"token", false},
		},
		Outputs: ActionMetadataOutputs{
			"response":      {"response"},
	...
	"actions/create-github-app-token@v1": {
		...
		Inputs: ActionMetadataInputs{
			"app-id":                                                 {"app-id", false},
			"app_id":                                                 {"app_id", false},
			"github-api-url":                                         {"github-api-url", false},
			"owner":                                                  {"owner", false},
			"permission-actions":                                     {"permission-actions", false},
			"permission-administration":                              {"permission-administration", false},
			"permission-checks":                                      {"permission-checks", false},
			"permission-codespaces":                                  {"permission-codespaces", false},
			"permission-contents":                                    {"permission-contents", false},
			"permission-dependabot-secrets":                          {"permission-dependabot-secrets", false},
			"permission-deployments":                                 {"permission-deployments", false},
			"permission-email-addresses":                             {"permission-email-addresses", false},
			"permission-environments":                                {"permission-environments", false},
			"permission-followers":                                   {"permission-followers", false},
			"permission-git-ssh-keys":                                {"permission-git-ssh-keys", false},
			"permission-gpg-keys":                                    {"permission-gpg-keys", false},
			"permission-interaction-limits":                          {"permission-interaction-limits", false},
			"permission-issues":                                      {"permission-issues", false},
			"permission-members":                                     {"permission-members", false},
			"permission-metadata":                                    {"permission-metadata", false},
			"permission-organization-administration":                 {"permission-organization-administration", false},
			"permission-organization-announcement-banners":           {"permission-organization-announcement-banners", false},
			"permission-organization-copilot-seat-management":        {"permission-organization-copilot-seat-management", false},
			"permission-organization-custom-org-roles":               {"permission-organization-custom-org-roles", false},
			"permission-organization-custom-properties":              {"permission-organization-custom-properties", false},
			"permission-organization-custom-roles":                   {"permission-organization-custom-roles", false},
			"permission-organization-events":                         {"permission-organization-events", false},
			"permission-organization-hooks":                          {"permission-organization-hooks", false},
			"permission-organization-packages":                       {"permission-organization-packages", false},
			"permission-organization-personal-access-token-requests": {"permission-organization-personal-access-token-requests", false},
			"permission-organization-personal-access-tokens":         {"permission-organization-personal-access-tokens", false},
			"permission-organization-plan":                           {"permission-organization-plan", false},
			"permission-organization-projects":                       {"permission-organization-projects", false},
			"permission-organization-secrets":                        {"permission-organization-secrets", false},
			"permission-organization-self-hosted-runners":            {"permission-organization-self-hosted-runners", false},
			"permission-organization-user-blocking":                  {"permission-organization-user-blocking", false},
			"permission-packages":                                    {"permission-packages", false},
			"permission-pages":                                       {"permission-pages", false},
			"permission-profile":                                     {"permission-profile", false},
			"permission-pull-requests":                               {"permission-pull-requests", false},
			"permission-repository-custom-properties":                {"permission-repository-custom-properties", false},
			"permission-repository-hooks":                            {"permission-repository-hooks", false},
			"permission-repository-projects":                         {"permission-repository-projects", false},
			"permission-secret-scanning-alerts":                      {"permission-secret-scanning-alerts", false},
			"permission-secrets":                                     {"permission-secrets", false},
			"permission-security-events":                             {"permission-security-events", false},
			"permission-single-file":                                 {"permission-single-file", false},
			"permission-starring":                                    {"permission-starring", false},
			"permission-statuses":                                    {"permission-statuses", false},
			"permission-team-discussions":                            {"permission-team-discussions", false},
			"permission-vulnerability-alerts":                        {"permission-vulnerability-alerts", false},
			"permission-workflows":                                   {"permission-workflows", false},
			"private-key":                                            {"private-key", false},
			"private_key":                                            {"private_key", false},
			"repositories":                                           {"repositories", false},
			"skip-token-revoke":                                      {"skip-token-revoke", false},
			"skip_token_revoke":                                      {"skip_token_revoke", false},
		},
		Outputs: ActionMetadataOutputs{
			"app-slug":        {"app-slug"},
	...
	"actions/first-interaction@v2": {
		Name: "First Interaction",
		Inputs: ActionMetadataInputs{
			"issue_message": {"issue_message", false},
			"pr_message":    {"pr_message", false},
			"repo_token":    {"repo_token", false},
		},
	},
	...
	"actions/setup-node@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"node-version":          {"node-version", false},
			"node-version-file":     {"node-version-file", false},
			"package-manager-cache": {"package-manager-cache", false},
			"registry-url":          {"registry-url", false},
			"scope":                 {"scope", false},
			"token":                 {"token", false},
		},
	...
	"aws-actions/configure-aws-credentials@v4": {
		...
		Inputs: ActionMetadataInputs{
			...
			"output-env-credentials":        {"output-env-credentials", false},
			...
			"use-existing-credentials":      {"use-existing-credentials", false},
	...
	"aws-actions/configure-aws-credentials@v5": {
		Name: "\"Configure AWS Credentials\" Action for GitHub Actions",
		Inputs: ActionMetadataInputs{
			"action-timeout-s":              {"action-timeout-s", false},
			"allowed-account-ids":           {"allowed-account-ids", false},
			"audience":                      {"audience", false},
			"aws-access-key-id":             {"aws-access-key-id", false},
			"aws-region":                    {"aws-region", true},
			"aws-secret-access-key":         {"aws-secret-access-key", false},
			"aws-session-token":             {"aws-session-token", false},
			"disable-retry":                 {"disable-retry", false},
			"force-skip-oidc":               {"force-skip-oidc", false},
			"http-proxy":                    {"http-proxy", false},
			"inline-session-policy":         {"inline-session-policy", false},
			"managed-session-policies":      {"managed-session-policies", false},
			"mask-aws-account-id":           {"mask-aws-account-id", false},
			"no-proxy":                      {"no-proxy", false},
			"output-credentials":            {"output-credentials", false},
			"output-env-credentials":        {"output-env-credentials", false},
			"retry-max-attempts":            {"retry-max-attempts", false},
			"role-chaining":                 {"role-chaining", false},
	...
	"dawidd6/action-send-mail@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"connection_url":   {"connection_url", false},
			"convert_markdown": {"convert_markdown", false},
			"envelope_from":    {"envelope_from", false},
			"envelope_to":      {"envelope_to", false},
			"from":             {"from", true},
			"html_body":        {"html_body", false},
			"ignore_cert":      {"ignore_cert", false},
			"in_reply_to":      {"in_reply_to", false},
	...
	"docker/login-action@v3": {
		...
		Inputs: ActionMetadataInputs{
			...
			"password":      {"password", false},
			"registry":      {"registry", false},
			"registry-auth": {"registry-auth", false},
			"username":      {"username", false},
		},
	},
	...
	"github/codeql-action/init@v3": {
		Name: "CodeQL: Init",
		Inputs: ActionMetadataInputs{
			"analysis-kinds":            {"analysis-kinds", false},
	...
	"google-github-actions/setup-gcloud@v2": {
		...
		Inputs: ActionMetadataInputs{
			...
			"skip_tool_cache":    {"skip_tool_cache", false},
			"version":            {"version", false},
		},
		Outputs: ActionMetadataOutputs{
			"version": {"version"},
	...
	"ncipollo/release-action@v1": {
		...
		Inputs: ActionMetadataInputs{
			...
			"generatereleasenotesprevioustag": {"generateReleaseNotesPreviousTag", false},
			"immutablecreate":                 {"immutableCreate", false},
	...
	"release-drafter/release-drafter@v6": {
		...
		Inputs: ActionMetadataInputs{
			"commitish":             {"commitish", false},
			"config-name":           {"config-name", false},
			"disable-autolabeler":   {"disable-autolabeler", false},
			"disable-releaser":      {"disable-releaser", false},
			"footer":                {"footer", false},
			"header":                {"header", false},
			"latest":                {"latest", false},
			"name":                  {"name", false},
			"prerelease":            {"prerelease", false},
			"prerelease-identifier": {"prerelease-identifier", false},
