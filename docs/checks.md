...
When some errors are detected under YAML anchors, actionlint reports them as follows.
...
actionlint also checks usage of anchors and aliases. reports recursive aliases and unused anchors as error.
