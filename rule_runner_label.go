...
var defaultRunnerOSCompats = map[string]runnerOSCompat{
	...
	"ubuntu-24.04-ppc64le":   compatUbuntu2404,
	"ubuntu-24.04-ppc64le-p10": compatUbuntu2404,
	"ubuntu-24.04-s390x":     compatUbuntu2404,
	"ubuntu-22.04":           compatUbuntu2204,
	"ubuntu-22.04-arm":       compatUbuntu2204,
	"ubuntu-22.04-ppc64le":   compatUbuntu2204,
	"ubuntu-22.04-ppc64le-p10": compatUbuntu2204,
	"ubuntu-22.04-s390x":     compatUbuntu2204,
